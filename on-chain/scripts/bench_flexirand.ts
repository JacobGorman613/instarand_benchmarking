...
import { keccak, flexirand_blinding_proof, get_random_bytes, get_random_uint256_2, get_random_uint256_4,get_random_uint256}from './input_factory';
...
const contractAddress = '0x251DA2b6836Ea3A62108Cdde2Ce14Dd9399c5F34';
...
(async () => {
    try {
        ...
        for (let i = 0; i < RUNS; i++) {
            await bench1(contract, accounts[0])
        }
