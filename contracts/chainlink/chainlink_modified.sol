...
contract GoldbergVrf {
  ...
  function _hashToCurve(uint256[2] memory pk, uint256 input) public view returns (uint256[2] memory rv) {
  ...
  /* ***************************************************************************
     ...
     * ***************************************************************************
     */
  function _randomValueFromVRFProof(Proof memory proof, uint256 seed) public view returns (uint256 output) {
    _verifyVRFProof(
      proof.pk,
      proof.gamma,
      proof.c,
