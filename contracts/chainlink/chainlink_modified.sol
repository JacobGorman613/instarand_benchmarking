// chainlink source code (only differences are contract name and visibility of functions)
// https://raw.githubusercontent.com/smartcontractkit/chainlink/develop/contracts/src/v0.8/vrf/VRF.sol
...
contract GoldbergVrf {
    ...
    function _fieldHash(bytes memory b) public pure returns (uint256 x_) {
    ...
    function _hashToCurve(
        ...
        rv = _newCandidateSecp256k1Point(
    ...
    ) public pure returns (bool verifies) {
        // solhint-disable-next-line gas-custom-errors
    ...
    */
    ...
    function _linearCombination(
        ...
        unchecked {
            ...
            // solhint-disable-next-line gas-custom-errors
            require(
                (cp1Witness[0] % FIELD_SIZE) != (sp2Witness[0] % FIELD_SIZE),
    ...
    function _verifyVRFProof(
        ...
        unchecked {
            ...
            uint256 derivedC = _scalarFromCurvePoints(
                hash,
                pk,
                gamma,
                uWitness,
